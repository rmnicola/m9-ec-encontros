...
const config = {
  ...
  projectName: 'm9-ec-encontros', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/rmnicola/m9-ec-encontros',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Módulo 9 EC. Built with Docusaurus.`,
      },
      prism: {
